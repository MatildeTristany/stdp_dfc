...
class AbstractLayer(nn.Module, ABC):
    ...
    def linearactivations(self, value):
        """Setter for the attribute linearactivations"""
        self._linearactivations = value

    @property
    def linearactivations_ss(self):
        """Getter for read-only attribute :attr:`linearactivations_ss`"""
        return self._linearactivations_ss
    
    @linearactivations_ss.setter
    def linearactivations_ss(self, value):
        """Setter for linearactivations_ss"""
        self._linearactivations_ss = value
    
    @property
    def activations_ss(self):
        """Getter for read-only attribute :attr:`activations_ss`"""
        return self._activations_ss

    @activations_ss.setter
    def activations_ss(self, value):
        """Setter for activations_ss"""
        self._activations_ss = value
    ...
    def forward_activationfunction(self, x):
        ...
        if self.forward_activation == 'tanh':
            ...
            return F.relu(x)
        elif self.forward_activation == 'cap_relu':
    ...
    def requires_grad(self):
        ...
        self._activations_ss.requires_grad = True
    ...
    def forward(self, x):
        ...
        self.linearactivations_ss = a

        self.activations = self.forward_activationfunction(a)
        self.activations_ss = self.forward_activationfunction(a)
